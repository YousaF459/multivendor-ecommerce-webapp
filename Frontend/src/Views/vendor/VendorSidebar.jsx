...
function VendorSidebar(){
    ...
    <ul className="nav nav-pills flex-column mb-auto nav flex-column pl-1 pt-2">
        ...
        <li className="mb-3">
            <Link to="/vendor/add-products/" className={isActiveLink(location.pathname,'vendor/add-products/') ? "nav-link text-white active" : "nav-link text-white" }>
        ...
        <li className="mb-3">
            <Link to={"/profile"} className={isActiveLink(location.pathname,'vendor/logout/') ? "nav-link text-white active" : "nav-link text-white" }>
