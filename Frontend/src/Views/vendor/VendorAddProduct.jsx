...
function VendorAddProduct() {
  ...
  useEffect(() => {
    if (vendorid) {
      setProduct(prev => ({ ...prev, vendor: Number(vendorid) }));
    }
  }, [vendorid]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosAPI.post(`vendor-create-product/`, formdata, {
    ...
    You must be logged in to view this section.
        ...
        <div className="container">
          <form onSubmit={handleSubmit} className="main-body">
            ...
            {/* SUBMIT BUTTON */}
            <button type="submit" className="btn btn-success mt-4 w-100">Submit Product</button>
