...
function Orders(){
    ...
    useEffect(()=>{
        axiosAPI.get(`customer/orders/${userData}/`)
        .then((res)=>{
            setOrders(res.data)
                  ...
                  <div className="col-lg-12 mb-4 mb-lg-0 h-100">
                    <table className="table align-middle mb-0 bg-white">
                      ...
                      <tbody>
                        ...
                        {orders?.map((oitem,oindex)=>(
                            <tr key={oindex}>
                          <td>
                            <p className="fw-bold mb-1">#{oitem.oid}</p>
                            <p className="text-muted mb-0">
                              {moment(oitem.date).format("MMM D, YYYY")}
                            </p>
                          </td>
                          <td>
                            <p className="fw-normal mb-1">{oitem.payment_status?.toUpperCase()}</p>
                          </td>
                          <td>
                            <p className="fw-normal mb-1">{oitem.order_status?.toUpperCase()}</p>
                          </td>
                          <td>
                            <span className="fw-normal mb-1">${oitem.total}</span>
                          </td>
                          <td>
                            <Link
                              to={`/customer/orders/${oitem.oid}/`}
