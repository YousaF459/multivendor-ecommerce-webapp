                            ...
                            <div className="col-xs-12 col-sm-12 col-md-12 text-left">
                                <div className="receipt-right">
                                    <h5 className="margin-top-10">
                                        Ecommerce<span className="text-warning">.</span>
                                    </h5>
                                    <p>
                                        <i className="fa fa-phone" /> +92 33535353
                                    </p>
                                    <p>
                                        <i className="fa fa-envelope" /> Ecommerce@gmail.com
                                    </p>
                                    <p>
                                        <i className="fa fa-location-arrow" /> Pakistan
                                    </p>
                                </div>
                            </div>
                        </div>
